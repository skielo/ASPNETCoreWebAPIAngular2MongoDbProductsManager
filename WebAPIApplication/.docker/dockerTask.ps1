...
.PARAMETER Clean
Removes the image webapiapplication and kills all containers based on that image.
...
Build a Docker image named webapiapplication
#>
...
$imageName="webapiapplication"
$projectName="webapiapplication"
$serviceName="webapiapplication"
